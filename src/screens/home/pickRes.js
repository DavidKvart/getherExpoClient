                    ...
                    <View style={styles.userCard}>
                      ...
                      <View style={styles.textTiming}>
                        ...
                        <View style={{ display: "flex" }}>
                          <Text style={styles.arrivaldata}>duration: {parseInt(usersTiming[friend._id]?.duration)}</Text>
                          <Text style={styles.arrivaldata}>distance: {parseFloat(usersTiming[friend._id]?.distance).toFixed(2)}</Text>
                        </View>
                      </View>
                    </View>
                  );
