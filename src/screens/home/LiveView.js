...
export default function LiveView() {
  ...
  const colors = ["#390099", "#9E0059", "#FFBD00", "#FF5400", "#31572C", "#511730", "#FB6F92", "#48CAE4", "#E63946", "#BDB246", "5F0F40"];
        ...
        <Animated.View showsVerticalScrollIndicator={false} style={[styles.info, rBottomSheetStyle]}>
          ...
          <View style={styles.resInfo}>
            ...
            <View style={styles.resInfoText}>
              ...
              <TouchableOpacity activeOpacity={0.7} style={styles.invite} onPress={() => navigation.navigate(ROUTES.ADD_FREINDS)}>
