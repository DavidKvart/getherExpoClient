        ...
        <View style={styles.container}>
          <View style={styles.wFull}>
            ...
            <View style={styles.loginBtnWrapper}>
              <TouchableOpacity onPress={() => navigation.navigate(ROUTES.JOIN_EVENT)} activeOpacity={0.7} style={styles.loginBtn}>
                <Image source={require("../../assets/JoinEvent2.jpeg")} style={{ height: "100%", width: "100%", borderRadius: "5%" }} />
                <Text style={styles.futureEventText}>Join event</Text>
              </TouchableOpacity>
            </View>
            <View style={styles.loginBtnWrapper}>
              <TouchableOpacity onPress={() => navigation.navigate(ROUTES.ADD_FREINDS)} activeOpacity={0.7} style={styles.loginBtn}>
                <Image source={require("../../assets/InstantEvent2.webp")} style={{ height: "100%", width: "100%", borderRadius: "5%" }} />
                <Text style={styles.futureEventText}>Create Instant event</Text>
              </TouchableOpacity>
            </View>
            <View style={styles.loginBtnWrapper}>
              <TouchableOpacity activeOpacity={0.7} onPress={signOut} style={styles.loginBtn}>
                <Image source={require("../../assets/FutureEvent2.jpeg")} style={{ height: "100%", width: "100%", borderRadius: "5%" }} />
